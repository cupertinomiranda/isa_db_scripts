...
# Unsupported
Relocation.new("R_ARC_N32_ME        0x1c  word32    bitfield    ME(S-A) (MES)")
Relocation.new("R_ARC_SECTOFF_ME    0x1d  word32    bitfield    ME((S-SECTSTART)+A) (MES)")

# arcompact elf me reloc
Relocation.new("R_ARC_SDA32_ME      0x1e  limm      signed      ME((S+A)-_SDA_BASE_) (MES)")
...
Relocation.new("R_ARC_TLS_DTPOFF    0x43  word32    dont        ME(S-TLS_REL)") # , 0, 2, 32, FALSE, 0, arcompact_elf_me_reloc, "R_ARC_TLS_DTPOFF",-1),
Relocation.new("R_ARC_TLS_DTPOFF_S9 0x49  word32    dont        ME(S-TLS_REL)") # , 0, 2, 32, FALSE, 0, arcompact_elf_me_reloc, "R_ARC_TLS_DTPOFF_S9",-1),
